...
# changing things requires a commit landing on cp-1, which is the gate.
#
...
data "aws_iam_policy_document" "gha_trust" {
  for_each = {
    ...
    cloudflare_iac_apply = [
      "repo:ludorl82/cloudflare-iac:ref:refs/heads/cp-1",
      "repo:ludorl82@34710674/cloudflare-iac@1312256183:ref:refs/heads/cp-1",
    ]
    ...
    aws_iac_apply = [
      "repo:ludorl82/aws-iac:ref:refs/heads/cp-1",
      "repo:ludorl82@34710674/aws-iac@1312256127:ref:refs/heads/cp-1",
    ]
...
# real guards are the trust policy (cp-1 branch of one repo only) and the
