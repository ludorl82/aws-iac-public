...
- **Stale AMIs** — `aws-example-com-20240510` and
  ...
  `master-example-com-preswap-20260721` is the rollback for the deleted
  master root volume; keep until you are confident, then deregister.

## Removed 2026-07-25

Residue of the decommissioned `master` node, deleted before the import so it
